...
Input::Input(Element& elem, SignalState st) : m_elem{elem}, m_inv{st == SignalState::inverted} {}
...
SignalState Input::state() const { return m_inv ? SignalState::inverted : SignalState::direct; }
...
Element::Element(SourceState st) : m_type{ElementType::source}, m_src_on{st == SourceState::on} {}
...
Element& operator>> (Element& lhs, Element& rhs) { return lhs >> Input{rhs, SignalState::direct}; }
