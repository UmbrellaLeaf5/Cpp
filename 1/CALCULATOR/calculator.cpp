...
void user_help ()
{
    ...
    cout << "! evaluating the expression in brackets, assigning new values to variables ('=')."
         << endl;
    cout << "To get the result of a calculation, use the symbol ';' to separate expressions and "
            "line breaks, or just use line breaks."
         << endl;
    cout << "An example of a working program using all the commands:" << endl;
    cout << "> # s = 10; $ p = 5; 2 + s; s = 5 * p; pow(p, 4); sqrt(s); s % 10; s / 5;"
            " s / (5 % 10) + 6 - 7; s = 8"
         << endl;
}
